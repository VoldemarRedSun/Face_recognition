...
class GetEmbedings:
    """
    Поиск лиц на изображениях и получение эмбеддингов этих лиц
    """
    ...
    def get_labels(self) -> dict:
        """
        Создание словаря с метками для каждого актера
        """
        dict_labels = dict()
    ...
    def get_embedings(self) -> Tuple[np.array, list]:
        """
        Получение embedings c распознанными лицами
        """
    ...
    def get_save_embedding(self) -> None:
        """
        Получение таргетов и эмбеддингов с последующей записью
        """
